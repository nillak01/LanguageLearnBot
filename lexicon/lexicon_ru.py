LEXICON_RU: dict[str, str] = {
    ...
    '/contacts':    '<b>Мои Контакты:</b>\n\n'
                    'Телефон: +7 (977) 415 56 04\n'
                    'Telegramm: https://t.me/nillak0_0\n'
                    'Почта: XXX@mail.ru',
    '/assistant':    'Начало общения с ассистентом, \n'
                     'Напишите слово с которым вы хотите составить'
                     ' предложение: ',
    'rock': 'Камень 🗿',
    'paper': 'Бумага 📜',
    'scissors': 'Ножницы ✂',
...
LEXICON_COMMANDS_RU: dict[str, str] = {
    '/start': 'Начать тест бота',
    '/help': 'Нужна помощь 0_0',
    '/contacts': 'Контакты моего господина'
}
